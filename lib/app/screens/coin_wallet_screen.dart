            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 15),
                  _buildInfoRow('Bugun yig\'ilgan', '${coinService.todayEarned} tanga'),
                  _buildInfoRow('Kunlik limit', '${coinService.dailyCoinLimit} tanga'),
                  _buildInfoRow('Qadam/tanga nisbati', '${coinService.stepsPerCoin} qadam = 1 tanga'),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (amount != null && amount >= 1000 && amount <= coinService.coins) {
                // Process withdrawal
                coinService.withdrawCoins(amount);
                Navigator.of(context).pop();
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('So\'rov qabul qilindi. 24 soat ichida amalga oshiriladi.'),
                  ),
                );
              } else {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Noto\'g\'ri miqdor. Minimal 1000 tanga kerak.'),
                  ),
                );
              }
            },
